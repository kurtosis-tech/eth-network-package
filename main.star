...
def run(plan, args):
	...
	all_participants, cl_genesis_timestamp, genesis_validators_root = participant_network.launch_participant_network(plan, args_with_right_defaults.participants, network_params, args_with_right_defaults.global_client_log_level)
