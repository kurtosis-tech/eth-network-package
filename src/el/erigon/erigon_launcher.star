...
el_admin_node_info = import_module("github.com/parithosh/eth-network-package/src/el/el_admin_node_info.star")
el_client_context = import_module("github.com/parithosh/eth-network-package/src/el/el_client_context.star")
...
def get_config(network_id, genesis_data, image, existing_el_clients, verbosity_level, extra_params):
	...
	# TODO remove this based on https://github.com/parithosh/eth2-merge-kurtosis-module/issues/152
